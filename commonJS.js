...
;window.executeOnEventDone("deferredload", function() {
    ...
    (function(a) {
        jQuery.expr[":"].parents = function(a, e, d) {
            return 1 > jQuery(a).parents(d[3]).length
        }
        ;
        ...
        a.parseParams = function(a) {
            for (var b = {}, d; d = h.exec(a); ) {
                var c = decodeURIComponent(d[1].replace(l, " "));
                void 0 != b[c] ? (b[c].constructor != Array && (b[c] = [b[c]]),
                b[c].push(decodeURIComponent(d[2].replace(l, " ")))) : b[c] = decodeURIComponent(d[2].replace(l, " "))
            }
            return b
        }
        ;
        a.fn.htmlView = function(b) {
            var e = {
                init: function(b, e, f) {
                    var d = a(this);
                    d.addClass("geofs-htmlView");
                    var c = a(d.attr("data-target"));
                    c = c.length ? c : d;
                    var g = d.attributes()
                      , h = c.attributes();
                    b = b || d.attr("action") || d.attr("href") || null;
                    f = a.extend({
                        method: "GET",
                        enctype: ""
                    }, h, g, f || {});
                ...
                load: function(b, e, g) {
                    return this.each(function() {
                        var d = a(this)
                          , c = d.data("htmlView");
                        c || (d.htmlView("init", b, e, g),
                        c = d.data("htmlView"));
                        var f = a.extend(d.data("htmlView").settings || {}, g || {})
                          , h = d.data("htmlView").state || {}
                          , k = b || d.data("htmlView").view || "";
                        k = k.replace(/\[.*\]/gi, function(a) {
                            return eval(a)[0]
                        });
                        null != d.data("htmlView").view && null != k && d.data("htmlView").view != k && (h = {});
                        var n = c.$context.serialize ? c.$context.serialize() : ""
                          , l = c.$context.attr("data");
                        n = a.parseParams(n + (l ? "&" + l : ""));
                        h = a.extend(h, e || {}, n);
                        f.processor && (h = window[f.processor](h));
                        c.view = k;
                        c.state = h;
                        c.settings = f;
                        d.data("htmlView", c);
                        f.urlHistory && (window.location.hash = k);
                        d.htmlView("abort");
                        c.$target.prepend('<div class="geofs-loading"></div>');
                        var m = function() {
                            d.trigger("ajaxSubmit");
                            var b = {
                                type: f.method,
                                data: h,
                                success: function(b) {
                                    if (f.responseProcessor)
                                        try {
                                            b = f.responseProcessor(b)
                                        } catch (p) {
                                            throw "$.fn.htmlView - Exception while processing response: " + p;
                                        }
                                    try {
                                        if ("replace" == f.contentmode) {
                                            var e = a(b);
                                            c.$target.replaceWith(e);
                                            c.$target = e
                                        } else
                                            c.$target.html(b);
                                    ...
                                    d.data("lastJqXHR", null)
                                },
                                error: function(a, b, c) {
                                    "abort" != b && (console.log(a.status + ": " + b + " " + c),
                                    d.trigger("viewChange"));
                                    d.data("lastJqXHR", null)
                                },
                                cache: !1
                            };
                            "multipart/form-data" == f.enctype && (b.data = new FormData(c.$context[0]),
                            b.contentType = !1,
                            b.processData = !1);
                            b = jQuery.ajax(k, b);
                            d.data("lastJqXHR", b)
                        ...
                        if (f.confirmModal)
                            a(f.confirmModal).show().find(".geofs-f-confirm").on("click", function() {
                                m()
                            });
                        else
                            m()
        ...
        var g, k, n = function(a) {
            var b = a.find(".slider-selection")
              , d = a.find(".slider-rail")
              , c = parseFloat(a.attr("data-min"))
              , f = parseFloat(a.attr("data-max"))
              , g = parseInt(a.attr("data-precision"))
              , h = f - c;
            d = d.width();
            return {
                min: c,
        ...
        a.fn.slider = function(b, e, d, c) {
            if ("value" == b)
                if (b = a(this),
                c || (c = n(b)),
                d && "none" != d && (e = (d.pageX - c.offset) * c.ratio + c.min),
                void 0 != e)
                    e = Math.max(c.min, Math.min(c.max, e)).toFixed(c.precision),
                    isNaN(e) && (e = c.min.toFixed(c.precision)),
                    c.$selectBar.width((e - c.min) * c.percRatio + "%"),
                    c.$input.val() != e && (c.$input.val(e),
                    "none" != d && b.trigger("change", e)),
                    d && b.trigger("userchange", e);
                else
                    return c.$input.val()
        }
        ;
        a(document).ready(function() {
            a(document).on("mousemove touchmove", function(a, e) {
                a.pageX = a.pageX || e || (a.changedTouches ? a.changedTouches[0].pageX : null);
                g && a.pageX && g.slider("value", null, a, k)
        ...
        ;
        a.loadAsyncScript = function(a, e) {
        ...
        a.haring = {
            create: function(b, e, d, c) {
                c = c || {};
                if (b.isHaring) {
                    var f = a(b);
                    b = f.find(".geofs-content").text()
                } else
                    f = a('<div class="geofs-haring"><div class="geofs-content"><p>' + b + '</p><div class="geofs-closeHaring"><div class="geofs-closeHaring-button">' + e + "</div></div></div></div>"),
                    a("body").append(f);
                b = m(b.replace(/[^A-z]/g, ""));
                0 < a(".geofs-haring." + b).length || (f.addClass(b),
                d && f.find(".geofs-closeHaring").click(d),
        ...
        a.fn.MDLTooltipEnhancer = function() {
            this.length && (this.each(function() {
                var b = a(this)
                  ...
                  , d = b.attr("id");
                d || (d = Math.random());
                b.attr("id", d).attr("title", null);
                b.after('<div class="mdl-tooltip ' + b.attr("data-tooltip-classname") + '" for="' + d + '">' + e + "</div>")
            }),
        ...
        a.loadDeferredImages = function(b) {
            b = b || a(document);
            b.find("[data-deferredsrc]").each(function(b, d) {
                a(d).attr("src", a(d).attr("data-deferredsrc")).removeAttr("data-deferredsrc")
            });
            b.find("[data-deferredbackground]").each(function(b, d) {
        ...
        a.carousel = function() {
            a("carousel").each(function() {
                function b() {
                    e.find(".visible").removeClass("visible");
                    var b = e.data("current");
                    if (void 0 == b) {
                        b = 0;
                        var d = new Image
                          , g = c.eq(0).attr("src");
                        d.onload = function() {
                            f[0] = a('<div class="photo-holder"></div>').css("background-image", "url(" + g + ")").prependTo(e);
                            setTimeout(function() {
                                f[0].addClass("visible")
                            }, 100)
                        }
                        ;
                        d.src = g
                    } else
                        f[b].addClass("visible"),
                        e.css("backgroundImage", "");
                    b++;
                    b >= c.length && (b = 0);
                    e.data("current", b);
                    f[b] || (f[b] = a('<div class="photo-holder"></div>').css("background-image", "url(" + c.eq(b).attr("src") + ")").prependTo(e))
                }
                var e = a(this);
                e.currentHolder = 0;
                var d = parseInt(e.attr("period")) || 5E3
                  , c = a(this).find("source")
                  , f = [];
                setInterval(b, d);
                b()
            })
...
window.executeOnEventDone("deferredload", function() {
    ...
    (function(a) {
        a.authentication = function(h) {
            var l = {
                ...
                initGoogle: function() {
                    window.gapi && gapi.load("auth2", function() {
                        ...
                        }).isSignedIn.listen(function(g) {
                            g ? a.authentication("loginGoogle") : a.authentication("disconnectGoogle")
                        });
                ...
                loginGoogle: function() {
                    if (!a.authentication.loggedInGoogle) {
                        var g = gapi.auth2.getAuthInstance().currentUser.get();
                        g.getBasicProfile();
                        a.authentication("loginServerSide", g.getAuthResponse().id_token, "google");
                        a.authentication.loggedInGoogle = !0
                    }
                },
                evaluateFacebookLogin: function(g) {
                    var h = function(g) {
                        "connected" == g.status && g.authResponse.accessToken ? a.authentication("loginServerSide", g.authResponse.accessToken, "facebook") : a.authentication.loggedInFacebook = !1
                    };
                    g ? h(g) : FB.getLoginStatus(function(a) {
                        h(a)
                    })
                },
                loginFacebook: function() {
                    a.authentication.loggedInFacebook || (FB.login(function(g) {
                        a.authentication("evaluateFacebookLogin", g)
                    }, {
                ...
                loginServerSide: function(g, h) {
                    geofs.userRecord.role > geofs.userRoles.anonymous || (g = {
                        action: "connect",
                        clientToken: g,
                        tokenProvider: h
                    },
                    a(".geofs-auth").htmlView("load", "/backend/accounts/auth.php", g, {
                        method: "POST",
                        contentmode: "replace",
                        success: function() {
                            a(document).trigger("loginchange")
                ...
                updateUI: function() {
                    ...
                    geofs.userRecord.role == geofs.userRoles.student && a("body").addClass("geofs-student-role"),
            ...
            if (l[h])
                return l[h].apply(this, Array.prototype.slice.call(arguments, 1));
            if ("object" !== typeof h && h)
                a.error("Method " + h + " does not exist on authentication plugin");
            else
